...
for i in range(400):
    ...
    for i in range(20):
       ...
       # print(augmentations["bboxes"][0])
        ...
        #print(filename)
        cv2.imwrite(filename,  cv2.cvtColor(augmented_img, cv2.COLOR_BGR2RGB)) 
        # augmented_img = Image.open(augmented_img)
        # augmented_img.save(filename)
